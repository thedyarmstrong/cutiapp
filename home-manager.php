...
<div class="wrapper">
	<header class="main-header">
		<a href="home-manager.php" class="logo"><span class="logo-mini">MRI</span><span class="logo-lg"><b>MRI Cuti</b> ONLINE</span></a>
	...
	<aside class="main-sidebar">
        ...
        <li class="treeview"><a href="home-manager.php?page=pre-approval-izin"><i class="fa fa-gear"></i> <span>Approval izin</span><small class="label pull-right bg-yellow"><?=$jmlcut?></small></a></li>

        <li class="treeview"><a href="#"><i class="fa fa-book"></i> <span>History</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
        <li class="treeview"><a href="home-manager.php?page=history-cuti-manager"><i class="fa fa-exchange"></i> <span>History Cuti</span></a></li>
