			...
			<div class='row'>
				...
				<div class='col-xs-5'>
					<div class='box-body box-profile'>
						<a class='btn btn-primary btn-block' href='home-hrd.php?page=activated-user&id_user=".$id_user."'>Activated</a>
					</div>
				</div>
				<div class='col-xs-5'>
					<div class='box-body box-profile'>
						<a class='btn btn-warning btn-block' href='home-hrd.php?page=deactivate-user&id_user=".$id_user."'>Deactivate</a>
					</div>
				</div>
				<div class='col-xs-1'></div>
			</div>
