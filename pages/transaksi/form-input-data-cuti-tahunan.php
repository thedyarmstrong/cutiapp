...
<section class="content">
    <div class="row">
        <div class="col-md-12">
					...
					<div class="panel-group">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								 <h4 class="panel-title"><i class="fa fa-plus"></i> Add Data Cuti 01 Jan 2018 - 09 Maret 2018<a data-toggle="collapse" data-target="#formaddcuti" href="#formaddcuti" class="collapsed"></a></h4>
							</div>
            ...
            <div class="panel panel-default">
							<div class="panel-heading">
								 <h4 class="panel-title"><i class="fa fa-plus"></i> Add Data Cuti TahunLalu<a data-toggle="collapse" data-target="#formtahunlalu" href="#formtahunlalu" class="collapsed"></a></h4>
							</div>
							<div id="formtahunlalu" class="panel-collapse collapse">
								<div class="panel-body">
									<form action="home-hrd.php?page=input-data-cuti-tahunlalu" class="form-horizontal" method="POST" enctype="multipart/form-data">
										<div class="form-group">
											<label class="col-sm-3 control-label">Jumlah Cuti Tahun Lalu</label>
											<div class="col-sm-3">
												<?php
												include "dist/koneksi.php";
                        $y = "Y";
                ...
                <th>Sisa Hak Cuti Tahun Lalu</th>
							</tr>
						</thead>
						<tbody>
						<?php
