...
<?php
  ...
  $insert =mysql_query("INSERT INTO tb_mohoncuti (no_cuti,nip,nama,divisi,tgl,dari,sampai,jml_hari,jenis)
                        VALUES ('$no_cuti','$nip','$nama','$divisi','$tgl','$dari','$sampai','$jml_hari','$tahunan')");
