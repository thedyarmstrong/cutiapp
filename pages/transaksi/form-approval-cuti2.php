			...
			<div class='row'>
				...
				<div class='col-xs-5'>
					<div class='box-body box-profile'>
						<a class='btn btn-primary btn-block' href='home-manager.php?page=approved-cuti2&no_cuti=$no_cuti&nip=$nip&jml_hari=$jml_hari'>Approved</a>
					</div>
				</div>
				<div class='col-xs-5'>
					<div class='box-body box-profile'>
						<a class='btn btn-warning btn-block' href='home-manager.php?page=not-approved-cuti2&no_cuti=$no_cuti'>Not Approved</a>
					</div>
				</div>
				<div class='col-xs-1'></div>
			</div>
