...
<head>
	...
	<title>MRI || Aplikasi Pengajuan Cuti Online</title>
...
<div class="wrapper">
	<header class="main-header">
		<a href="home-hrd.php" class="logo"><span class="logo-mini">MRI</span><span class="logo-lg"><b>MRI Cuti</b> ONLINE</span></a>
	...
	<aside class="main-sidebar">
        ...
        <li class="treeview"><a href="#"><i class="fa fa-book"></i> <span>History</span><i class="fa fa-angle-left pull-right"></i></a>
          ...
          <li><a href="home-hrd.php?page=history-cuti-hrd"> <i class="fa fa-caret-right"></i>History Cuti</a></li>
	...
	<div class="content-wrapper">
		<section class="content">
          ...
          case 'input-data-cuti-tahunlalu': include "pages/transaksi/input-data-cuti-tahunlalu.php"; break;
          ...
          case 'alasan': include "pages/transaksi/alasan.php"; break;
          case 'alasanproses': include "pages/transaksi/alasanproses.php"; break;
					case 'history-cuti-hrd': include "pages/view/history-cuti-hrd.php"; break;
          case 'history-izin-hrd': include "pages/view/history-izin-hrd.php"; break;
          case 'edittanggal': include "pages/transaksi/edittanggal.php"; break;
	...
	<footer class="main-footer">
		...
		Copyright &copy; 2018 <a href="#" target="_blank"> MRI cuti ONLINE</a>. All rights reserved
	</footer>
</div>
	<!-- ./wrapper -->
	<!-- jQuery 2.1.4 -->
